...
type ReceitaProps = NativeStackScreenProps<
  RootStackParamList,
          ...
          <ScrollView>
            ...
            >
              <Text style={{ marginVertical: 10 }}>
                Receita do Mestre, confia!
              </Text>
              <Button
                mode="contained"
                onPress={() => navigation.navigate('Petit Gateau do Jacquin')}
              >
            ...
            >
              <Text style={{ marginVertical: 10 }}>
                Mermão, é da fodendo Palmirinha, quer mais o que?
              </Text>
              <Button
                mode="contained"
                onPress={() =>
                  navigation.navigate('Bolinho de Chuva da Palmirinha')
                }
              >
                Bora Fazer!
              </Button>
            ...
            >
              <Text style={{ marginVertical: 10 }}>
                O Louro se foi, mas as receitas ficaram, não perca...
              </Text>
              <Button
                mode="contained"
                onPress={() =>
                  navigation.navigate('Bolo de Milho da Ana Maria')
                }
              >
...
function Receita1({ navigation }: ReceitaProps) {
  return (
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
      <ScrollView>
        <Text
          style={{ fontSize: 21, marginVertical: 16, marginHorizontal: 16 }}
        >
          Ingredientes: {`\n`}
          ...
          Modo de Preparo: {`\n`}
          {'\n'}
          1. Derreta em banho-maria 200 gramas de chocolate meio amargo e 2
          colheres de sopa sem sal. Reserve. {`\n`}
          {'\n'}
          2. Na bateira, coloque 2 ovos, 2 gemas, meia xícara de chá de açúcar.
          Bata até obter um creme claro. {`\n`}
          {'\n'}
          3. Em seguida, adicione a mistura de chocolate, 2 colheres de sopa de
          farinha de trigo e misture. {`\n`}
          {'\n'}
          4. Transfira a mistura para forminhas untadas com manteiga e
          enfarinhadas. {`\n`}
          {'\n'}
          5. Leve para assar em forno preaquecido a 200 graus Celsius de 6 a 10
          minutos. {`\n`}
          {'\n'}
    ...
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
      <ScrollView>
        ...
        >
          ...
          Modo de Preparo{`\n`}
          {'\n'}
          1. Numa tigela, junte os ovos, a manteiga, o açúcar e o sal e misture
          muito bem. {`\n`}
          {'\n'}
          2. Acrescente alternadamente à mistura o leite e a farinha de trigo,
          mexendo sempre com uma colher. {`\n`}
          {'\n'}
          3. Junte o fermento e misture bem. {`\n`}
          {'\n'}
          4. Numa panela média, coloque bastante óleo e leve ao fogo alto para
          aquecer. {`\n`}
          {'\n'}
          5. Quando o óleo estiver quente, abaixe o fogo. {`\n`}
          {'\n'}
          6. Com duas colheres de sobremesa, modele os bolinhos. Encha uma das
          colheres com a massa e passe de uma colher para a outra, até que a
          massa fique com um formato arredondado. {`\n`}
          {'\n'}
          7. Com cuidado, coloque pequenas porções de bolinhos no óleo quente.
          Deixe fritar até que os bolinhos fiquem dourados. {`\n`}
          {'\n'}
          8. Com uma escumadeira, retire os bolinhos e coloque sobre um prato
          forrado com papel-toalha. {`\n`}
          {'\n'}
          9. Num prato fundo, coloque açúcar e canela em pó e misture bem. Passe
          os bolinhos por essa mistura até envolvê-los completamente. Sirva a
          seguir. {`\n`}
          {'\n'}
        </Text>
        <Button
    ...
    <View style={{ flex: 1 }}>
      <ScrollView>
        ...
        >
          ...
          – 3 ovos{`\n`}– 1/2 lata de óleo{`\n`}– 1 lata de açúcar{`\n`}– 1 lata
          de fubá fino ou mimoso{`\n`}– 1 col sopa de fermento químico{`\n`}
          {`\n`}
          Modo de Preparo{`\n`}
          {'\n'}
          Bate tudo no liquidificador deixando o fermento por ultimo (bata pouco
          só pra misturar), coloque em forma de 21 a 24cm de diâmetro e leve
          para assar em 180ºC em forno preaquecido por aproximadamente 50 min.
        </Text>
        <Button
          mode="contained"
          onPress={() => navigation.goBack()}
    ...
    <PaperProvider>
      <NavigationContainer>
        <Stack.Navigator initialRouteName="Tela de Login">
          ...
          <Stack.Screen
            name="Bolinho de Chuva da Palmirinha"
            component={Receita2}
          />
          <Stack.Screen
            name="Bolo de Milho da Ana Maria"
            component={Receita3}
          />
        </Stack.Navigator>
      </NavigationContainer>
